/*
  ...
  2024-11 Ronny SC           - Servo-GPIO und Buzzer-GPIO getauscht da beim S3-Chip nicht auf allen GPIOs PWM zur Verfügung steht:
...
// Servo
const int servo_pin = 2;               //geändert zum Original                 
...
static int buzzer_pin = 33;           //geändert zum Original        
